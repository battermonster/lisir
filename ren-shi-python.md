---
description: 认识了解python
---

# 1.认识Python

## 1. Python发展历史 <a id="1-python&#x53D1;&#x5C55;&#x5386;&#x53F2;"></a>
...
![](.gitbook/assets/t01adb26d853648ae41.jpg)
...
![](.gitbook/assets/01-di-1-tian-15.jpg)
...
* Python的作者是Guido van Rossum
* Python是龟叔在1989年圣诞节期间，为了打发无聊的圣诞节而用C编写的一个编程语言
* Python正式诞生于1991年
* Python的解释器如今有多个语言实现，我们常用的是CPython（官方版本的C语言实现），其他还有Jython（可以运行在Java平台）、IronPython（可以运行在.NET和Mono平台）、PyPy（Python实现的，支持JIT即时编译）
* Python目前有两个版本，Python2和Python3，最新版分别为2.7.12和3.7.1，现阶段大部分公司用的是Python2
* Life is shot, you need Python. 人生苦短，我用Python。
* 2018年1月份 编程语言流行排行榜 

![](.gitbook/assets/2018010819345542696.png)

## 2. Python优缺点 <a id="2-python&#x4F18;&#x7F3A;&#x70B9;"></a>
...
## 3. Python应用场景 <a id="3-python&#x5E94;&#x7528;&#x573A;&#x666F;"></a>
